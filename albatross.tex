...
$if(school-quotes)$
% declare school specific quote style and apply it
...
\titleformat{\section} % format sections
  {$if(school-heading-size)$\fontsize{15pt}{15pt}\selectfont$else$\large$endif$\scshape}{\thesection}{0.5cm}{}
\titleformat{\subsection} % format subsections
  {$if(school-heading-size)$\fontsize{14pt}{14pt}\selectfont$else$\large$endif$\scshape}{\thesubsection}{0.5cm}{}
\titleformat{\subsubsection} % format subsubsections
  {$if(school-heading-size)$\fontsize{13pt}{13pt}\selectfont$else$\large$endif$\scshape}{\thesubsubsection}{0.5cm}{}
